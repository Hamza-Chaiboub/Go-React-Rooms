...
export const RoomsTopActionButton = ({Icon, tooltipText, TargetModal, modalProps = {}, children, classStyles, size = 24} : RoomsTopActionButtonProps) => {
    ...
    return (
        <>
        <div onClick={handleOpen} className={`flex items-center relative group bg-zinc-100 dark:bg-zinc-300 rounded-full p-2 cursor-pointer hover:bg-zinc-200 dark:hover:bg-zinc-400 ${classStyles}`}>
            <div>
                <Icon size={size} />
